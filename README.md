...
- [CLAUDE.md](CLAUDE.md) — Full technical reference, API docs, build details
- [tools/api_server/](tools/api_server/) — REST API server setup and endpoints
- [app/wibandwob.prompt.md](app/wibandwob.prompt.md) — Wib & Wob personality system
