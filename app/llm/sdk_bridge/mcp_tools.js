...
/**
 * Build native Agent SDK tool definitions (no MCP server).
 * These mirror the MCP tools but are passed directly to the SDK `tools` option.
 */
        ...
        tool(
            ...
            async (args) => {
                ...
                return {
                    content: [{
                        type: "text",
                        text: `✨ Created ${args.type} window: ${response.data.id}\nTitle: ${response.data.title}\nPosition: (${response.data.rect.x}, ${response.data.rect.y})\nSize: ${response.data.rect.w}x${response.data.rect.h}`
                    }]
                };
            }
        ),
        tool(
            ...
            async (args) => {
                ...
                return {
                    content: [{
                        type: "text", 
                        text: `✨ Moved window ${args.windowId} to (${response.data.rect.x}, ${response.data.rect.y}), size ${response.data.rect.w}x${response.data.rect.h}`
                    }]
                };
            }
        ),
